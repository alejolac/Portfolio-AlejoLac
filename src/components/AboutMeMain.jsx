        ...
        <>
            ...
            <div className='aboutMeMain-content'>
                <div className='aboutMeMain-text'>
                    ...
                    <p>
                        I'm currently studying at <a target="_blank" href="https://jovenesaprogramar.edu.uy">Jovenes a programar</a> a course of <a target="_blank" href="https://ceibal.edu.uy">Ceibal</a> where did i learn all all the knowledge of a front end and deepen soft skills, and they are helping me get my for my first job as a developer.
                    </p>
                </div>
